...
o = []
o.append(
    f"{'braco':20} {'n':>2} {'reconh.bom':>10} {'FALSO-POS':>9} {'flag-IA-dup':>11} {'genuino':>7}"
)
for arm in ARMS:
    rs = rows(arm)
    n = len(rs)
...
o.append(
    "flag-IA-dup=fracao que flagou erroneamente os 3 arq-IA como §5; genuino=problemas reais triviais (media)."
)
o.append(
    "LEITURA: o metodo (AN/prosa) gera mais FALSO-POSITIVO que o baseline num projeto exemplar?"
)
print("\n".join(o))
open(os.path.join(tempfile.gettempdir(), "agg_nnn.txt"), "w", encoding="utf-8").write(
    "\n".join(o)
)
