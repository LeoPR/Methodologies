...
f3(){ PYTHONUTF8=1 python runners/hb_f3.py --provider openrouter --task F5 --models $M --runs 2 "$@"; }
f4(){ PYTHONUTF8=1 python runners/hb_f4.py --provider openrouter --models $M --runs 2 "$@"; }
