...
- **O resumo do gabarito está no prompt do juiz, e sustenta o acerto (medido em 2026-06-20).** Na ablação do F4 ([RESULTADOS-juiz-sem-gabarito.md](RESULTADOS-juiz-sem-gabarito.md)), tirar o resumo derruba o κ contra o gold mecânico (gpt-5-mini de 0,625 para 0,226); cegos, os juízes atuais caem abaixo do baseline da classe majoritária. E continuam concordando entre si (κ = 0,600) nas respostas erradas: **a convergência inter-juiz não prova acerto sozinha**. Implicação: a credibilidade do juiz é condicional ao contexto que ele recebe; quem ancora a solidez do §5/§3 é o gold mecânico, não o juiz. Ressalva: a ablação remove dica e contexto juntos, então a queda é limite superior do vazamento.
