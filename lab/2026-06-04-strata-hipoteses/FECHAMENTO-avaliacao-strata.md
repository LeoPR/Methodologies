...
| Juízes | DIRECIONAL | O argumento e o auto-ceticismo são fortes, e o Krippendorff agora está medido: α = 0,918 no F4 (sólido), α = 0,467 no F3 (frágil, como já se dizia). A literatura 2024-2026 recalibra a defesa cross-vendor de binário para escala (erro correlacionado cross-família; independência = neff, não chave liga/desliga) e corrobora "convergência ≠ correção". Mas o juiz ainda tem o gabarito no prompt, a verdade-base é família única, e PoLL segue não medido; ECE rebaixado para "plausível, não reconfirmado". Ver [confronto](RESULTADOS-confronto-literatura.md) e [fundamento](FUNDAMENTO-juiz-escala-mensuravel.md). |
