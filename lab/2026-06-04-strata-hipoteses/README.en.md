...
forms** of the same content (human narrative + AI-native) invites divergence: it is
the very error §5 condemns. The design must have **one canonical** form and the other
**generated** from it:
